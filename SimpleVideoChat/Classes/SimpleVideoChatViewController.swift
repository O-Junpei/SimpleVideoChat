...
public class SimpleVideoChatViewController: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        remoteVideoView.delegate = self as! RTCEAGLVideoViewDelegate
    ...
    func prepareNewConnection() -> RTCPeerConnection {
        ...
        peerConnection = peerConnectionFactory.peerConnection(
            with: configuration, constraints: peerConnectionConstraints, delegate: self as! RTCPeerConnectionDelegate)
        //...つづく...
